...
class Feed(Host):
	def __init__(self, title, link, description = None, language = None, copyright = None, managingEditor = None, webMaster = None, pubDate = None,
		...
		description -- Optional. Phrase or sentence describing the channel.
